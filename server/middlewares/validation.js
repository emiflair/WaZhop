...
const { isValidAfricanPhone } = require('../utils/helpers');
...
exports.validateRegister = [
  ...
  body('whatsapp')
    ...
    .custom((value) => {
      ...
      // Accept African numbers (with backwards-compatible Nigerian local formats)
      return isValidAfricanPhone(trimmed);
    })
    .withMessage('Please provide a valid WhatsApp number (e.g., +233201234567 or +2348012345678)'),
