          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-12">
            <div className="text-center">
              ...
              <p className="text-gray-600 dark:text-gray-300 text-lg">
                Pick your colors, upload your logo, and make your shop truly yours.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600 dark:text-gray-300 text-lg">
                Buyers contact you directly on WhatsApp. No middlemen, no hassles.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600 dark:text-gray-300 text-lg">
                Launch your store in minutes. Upgrade anytime to unlock more features.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="bg-white dark:bg-gray-900 p-6 rounded-xl shadow-md">
              ...
              <p className="text-gray-600 dark:text-gray-300">
                Enter your business name, upload your logo, and choose a style.
              </p>
            </div>
            ...
            <div className="bg-white dark:bg-gray-900 p-6 rounded-xl shadow-md">
              ...
              <p className="text-gray-600 dark:text-gray-300">
                List your products with images, descriptions, and prices easily.
              </p>
            </div>
            ...
            <div className="bg-white dark:bg-gray-900 p-6 rounded-xl shadow-md">
              ...
              <p className="text-gray-600 dark:text-gray-300">
                Send your unique shop link via WhatsApp, Instagram, or anywhere.
              </p>
            </div>
            ...
            <div className="bg-white dark:bg-gray-900 p-6 rounded-xl shadow-md">
              ...
              <p className="text-gray-600 dark:text-gray-300">
                Buyers reach out directly to you. You stay in control and make your profit.
              </p>
            </div>
          </div>
        </div>
