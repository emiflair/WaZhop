...
export default function MarketplaceSearchScreen({
  ...
  return (
    <>
      {/* Backdrop overlay */}
      <div 
        className="fixed inset-0 z-[1040] bg-black/30 dark:bg-black/60 backdrop-blur-sm"
        onClick={onClose}
      ...
      <div className="fixed left-0 right-0 z-[1050] mx-4 rounded-2xl shadow-2xl overflow-hidden" style={{ top: 'calc(env(safe-area-inset-top) + 70px)' }}>
        ...
        <div className="bg-white/95 dark:bg-gray-900/95 backdrop-blur-xl border border-gray-200/50 dark:border-gray-700/50">
          {/* Header */}
        ...
        <form onSubmit={onSubmit} className="space-y-5 pt-5">
          <div className="relative">
            ...
            <input
              ...
              className="w-full rounded-xl border border-gray-200 bg-white/50 dark:bg-gray-800/50 backdrop-blur-sm pl-10 pr-11 py-3 text-sm text-gray-900 placeholder:text-gray-400 focus:border-primary-500 focus:ring-2 focus:ring-primary-500/20 dark:border-gray-700 dark:text-gray-100"
              style={{ fontSize: '16px' }}
              value={searchInput}
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            <div className="flex flex-col gap-1.5">
              ...
              <select
                ...
                className="input text-sm bg-white/50 dark:bg-gray-800/50 border-gray-200 dark:border-gray-700 backdrop-blur-sm"
              >
